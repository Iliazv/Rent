# Generated by Django 4.0.1 on 2023-01-09 10:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_image', models.ImageField(blank=True, default='', upload_to='announcement_images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annoucement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pictures', to='estate.annoucement')),
            ],
        ),
        migrations.CreateModel(
            name='Favorite',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('annoucement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favorites', to='estate.annoucement')),
